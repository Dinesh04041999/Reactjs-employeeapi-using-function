        ...
        <form method="post" name="userRegistrationForm" onSubmit={(e) => this.submituserRegistrationForm(e)}>
          <div className="container-1" id="form">
            <div className="row mt-5" style={{ height: "50px", padding: "5px", marginTop: "35px" }}>
              ...
              <div className="col-md-4">
                ...
                {!this.props.data && <input type="text" name="id" autoComplete="off" disabled={true}
                  defaultValue={
              ...
              <div className="col-md-4" style={{ padding: "0px ", border: "1px rgb(15, 15, 15) solid" }}>
                <div className="short-div" style={{  position: "relative",zIndex:"1" }}>
                  {this.props.data && <img src={this.state.fields.file }alt="" style={{ height: "300px", width: "360px", backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundImage: `url(${this.props.data.file})` }} />}
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              ...
              {!this.props.data && <input type="text" name="employeename" minLength="4" maxLength="24" autoComplete="off"
                defaultValue={
              ...
              {this.props.data && <input type="text" name="employeename" autoComplete="off"
                defaultValue={
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              ...
              {!this.props.data && <input type="number" name="employeesalary" style={{ marginTop: '10px' }} autoComplete="off"
                defaultValue={
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              ...
              {!this.props.data && <input type="number" name="employeeage" autoComplete="off"
                defaultValue={
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              ...
              {!this.props.data && <input type="text" name="email" autoComplete="off"
                defaultValue={
            ...
            <div className="col-md-3 mt-1">
              ...
              {!this.props.data && <input type="file" name="file"
          ...
          <div className="row"
            ...
            <div className="col-md-4">
              ...
              {!this.props.data && <input type="text" name="designation" minLength="2" maxLength="24" autoComplete="off"
                defaultValue={
